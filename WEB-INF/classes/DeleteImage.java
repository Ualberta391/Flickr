/***
    Servlet for deleting an image from the database.
    Servlet is called when the image owner selects the Delete Image button
    the display/displayImage.jsp module.
***/
...
public class DeleteImage extends HttpServlet {
	...
	throws ServletException, IOException {
        ...
        try {
            // Get the pic_id from the .ajax call
