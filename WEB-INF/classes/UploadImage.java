/***
    ...
    to thumbnail size, and is accessed from the uploading/uploadImage.jsp module
    
    A lot of the code seen here was taken from the example provided by Li-Yan Yuan.
***/
...
public class UploadImage extends HttpServlet {
    ...
    private static Connection getConnected( String drivername,
					    ...
					    String password  ) 
	throws Exception {
        // Returns the connection object to access the database
