...
<html>
    ...
    <div id="subContainer" style="width:300px">
		...
		String sql = ("select user_name from persons where user_name='" + friend +
                      "' AND '" + friend + "' != '" + session_user + "'");
        try {
	    ...
	    if(skip == 0) {
            sql = ("select group_id from groups where '" + session_user + 
                   "' = user_name AND '" + groupName + "' = group_name");
		    try {
                stmt = conn.createStatement();
		    ...
		    sql = ("Insert into group_lists values ('" + groupID + "','" + friendToAdd + 
                   "', DATE'" + date + "', '" + notice + "')");
		    try {
                stmt = conn.createStatement();
            ...
            String sql = ("select group_id from groups where group_name = '" + groupName + 
